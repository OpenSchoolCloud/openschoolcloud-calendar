...
fun ModeSelectionScreen(
    ...
    Column(
        ...
        Image(
            ...
            modifier = Modifier.size(80.dp, 67.dp),
        ...
        ElevatedCard(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.mode_standalone_title),
                ...
                Text(
                    text = stringResource(R.string.mode_standalone_description),
                ...
                Button(
                    ...
                    Text(stringResource(R.string.mode_standalone_button))
                }
            }
        }
        ...
        OutlinedCard(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.mode_nextcloud_title),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.Bold,
                    color = MaterialTheme.colorScheme.onSurface
                )
                ...
                Text(
                    text = stringResource(R.string.mode_nextcloud_description),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                ...
                OutlinedButton(
                    ...
                    Text(stringResource(R.string.mode_nextcloud_button))
                }
            }
        }
